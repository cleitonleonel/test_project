...
class BaseTypeEmail:
    ...
    data_paramters['COMPANY_BANNER_ALT'] = 'Mlx'
    data_paramters['COMPANY_NAME'] = "Otma Soluções em Tecnologias e Consultorias LTDA"
