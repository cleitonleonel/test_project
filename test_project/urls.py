...
from apps.views import index_page, login_page, signup_page, logout_page, change_password_page, reset_password_page
...
urlpatterns = [
    ...
    url(r'^forgot_password/$', reset_password_page),
